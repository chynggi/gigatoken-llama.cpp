...
#include "ggml-cuda/xing4_0-hc.cuh"
...
static bool ggml_cuda_should_fuse_mul_mat_vec_q(const ggml_tensor * tensor) {
    ...
    bool use_mul_mat_vec_q = ggml_is_quantized(src0->type) && !bad_padding_clear && src1->type == GGML_TYPE_F32 &&
                             ...
                             ggml_cuda_should_use_mmvq(src0->type, cc,
                                                       tensor->op == GGML_OP_MUL_MAT_ID ? src1->ne[2] : src1->ne[1]);
...
static bool ggml_cuda_compute_forward(ggml_backend_cuda_context & ctx, struct ggml_tensor * dst) {
    switch (dst->op) {
        ...
        case GGML_OP_DSV4_HC_POST:
            ...
            break;
        case GGML_OP_XING4_0_HC_COMB:
            ggml_cuda_op_xing4_0_hc_comb(ctx, dst);
            break;
        case GGML_OP_XING4_0_HC_PRE:
            ggml_cuda_op_xing4_0_hc_pre(ctx, dst);
            break;
        case GGML_OP_XING4_0_HC_POST:
            ggml_cuda_op_xing4_0_hc_post(ctx, dst);
            break;
        ...
        case GGML_OP_CPY:
            {
                ...
                if (src0_type == GGML_TYPE_Q4_1 && src1_type == GGML_TYPE_F16) {
                    return true;
                }
                ...
                if (src0_type == GGML_TYPE_Q5_0 && src1_type == GGML_TYPE_F16) {
                    return true;
                }
                ...
                if (src0_type == GGML_TYPE_Q5_1 && src1_type == GGML_TYPE_F16) {
                    return true;
                }
                ...
                if (src0_type == GGML_TYPE_IQ4_NL && src1_type == GGML_TYPE_F16) {
                    return true;
                }
